...
test_03--fixtures/a/test_03-3--module-scope.py 
    SETUP    M cards_db
        test_03--fixtures/a/test_03-3--module-scope.py::test_empty (fixtures used: cards_db).
        test_03--fixtures/a/test_03-3--module-scope.py::test_two (fixtures used: cards_db).
    TEARDOWN M cards_db

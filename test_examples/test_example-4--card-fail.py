...
test_examples/test_example-4--card-fail.py:7: AssertionError
...
# Show all mismatches
"""
$ pytest -vv test_examples/test_example-4--card-fail.py
===================================================================================================== test session starts ======================================================================================================
...                                                                                                                                                                                                           

test_examples/test_example-4--card-fail.py::test_equality_fail FAILED                                                                                                                                                    [100%]
...
test_examples/test_example-4--card-fail.py:7: AssertionError
=================================================================================================== short test summary info ====================================================================================================
FAILED test_examples/test_example-4--card-fail.py::test_equality_fail - AssertionError: assert Card(summary='sit there', owner='brian', state='todo', id=None) == Card(summary='do something', owner='okken', state='todo', id=None)
====================================================================================================== 1 failed in 0.11s =======================================================================================================
"""

# With "if __name__ == "__main__":" we can start the test with Python
"""
$ python test_examples/test_example-4--card-fail.py
Traceback (most recent call last):
  File ".../test_examples/test_example-4--card-fail.py", line 11, in <module>
    test_equality_fail()
  File ".../test_examples/test_example-4--card-fail.py", line 7, in test_equality_fail
    assert c1 == c2
AssertionError
"""

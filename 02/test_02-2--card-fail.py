...
"""
$ pytest 02/test_02-2--card-fail.py
===================================================================================================== test session starts ======================================================================================================
###                                                                                                                                                                                                          

02/test_02-2--card-fail.py F                                                                                                                                                                             [100%]
...
02/test_02-2--card-fail.py:7: AssertionError
...
# Show all mismatches
"""
$ pytest -vv 02/test_02-2--card-fail.py
===================================================================================================== test session starts ======================================================================================================
###                                                                                                                                                                                                           

02/test_02-2--card-fail.py::test_equality_fail FAILED                                                                                                                                                    [100%]
...
02/test_02-2--card-fail.py:7: AssertionError
=================================================================================================== short test summary info ====================================================================================================
FAILED 02/test_02-2--card-fail.py::test_equality_fail - AssertionError: assert Card(summary='sit there', owner='brian', state='todo', id=None) == Card(summary='do something', owner='okken', state='todo', id=None)
====================================================================================================== 1 failed in 0.11s =======================================================================================================
"""

# With "if __name__ == "__main__":" we can start the test with Python
"""
$ python 02/test_02-2--card-fail.py
Traceback (most recent call last):
  File ".../02/test_02-2--card-fail.py", line 11, in <module>
    test_equality_fail()
  File ".../02/test_02-2--card-fail.py", line 7, in test_equality_fail
    assert c1 == c2
AssertionError
"""

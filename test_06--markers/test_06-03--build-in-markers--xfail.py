...
$ pytest -k 06-03 -v -ra
###
test_06--markers/test_06-03--build-in-markers--xfail.py::test_less_than XFAIL (Card < comparison not supported in 1.x) 
test_06--markers/test_06-03--build-in-markers--xfail.py::test_xpass XPASS (XPASS demo with strict=False)  
test_06--markers/test_06-03--build-in-markers--xfail.py::test_xfail_strict FAILED 
###
=================================================================================================== short test summary info ====================================================================================================
XFAIL test_06--markers/test_06-03--build-in-markers--xfail.py::test_less_than - Card < comparison not supported in 1.x
XPASS test_06--markers/test_06-03--build-in-markers--xfail.py::test_xpass - XPASS demo with strict=False
FAILED test_06--markers/test_06-03--build-in-markers--xfail.py::test_xfail_strict
###
"""
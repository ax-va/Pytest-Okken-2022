...
"""
$ pytest -k test_example-06-08 -v --disable-warnings
###
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_zero_card PASSED
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_three_card PASSED
###
"""
...
"""
$ pytest -k test_example-06-08 -v -s --disable-warnings
###
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_zero_card PASSED
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_three_card PASSED
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_no_marker PASSED
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_marker_with_no_param PASSED
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_three_cards 
...
PASSED
test_example-06-08--markers--marker-parametrization-changing-fixtures.py::test_ten_cards PASSED
###
"""